    ...
    <div className="min-h-screen py-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome back, {userProfile.name || 'User'}! Here's your personalized career insights.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-start gap-6">
              <div className={`w-20 h-20 ${colorClasses[riasecInfo.color as keyof typeof colorClasses]} rounded-xl flex items-center justify-center border-2`}>
                <span className="text-3xl font-bold">{userProfile.riasecType}</span>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-2">{riasecInfo.name} Type</h2>
                <p className="text-lg text-gray-600 mb-4">{riasecInfo.description}</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Update Skills</h3>
            <p className="text-gray-600">Add or modify your skills to get better job recommendations</p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Update Interests</h3>
            <p className="text-gray-600">Update your job interests to discover more opportunities</p>
          </button>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Job Matching Insights</h2>
          </div>
          ...
          {recommendedJobs.length > 0 && (
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Top Job Matches for You</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Suitable Job Categories for {riasecInfo.name} Type</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-3xl font-bold mb-2">{recommendedJobs.length}</div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-3xl font-bold mb-2">{userProfile.skills?.length || 0}</div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div className="text-3xl font-bold mb-2">{userProfile.jobInterests?.length || 0}</div>
